...
namespace _2B_Egypt.Application.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<ResponseDTO<IEnumerable<ProductDTO>>> GetAllRelatedProducts(string ParentCatID)
        {
            return null;
        }
        ...
        Task<ResponseDTO<IQueryable<CategoryWithRelatedProducts>>> ICategoryService.GetAllAsync()
        {
            throw new NotImplementedException();
        }
